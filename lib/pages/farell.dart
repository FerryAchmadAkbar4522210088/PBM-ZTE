...
class _FarellPageState extends State<FarellPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Profil Farell", style: TextStyle(color: Color(0xFFBFA181))),
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: const [
                      Text("Nama Lengkap: Farell Rakha Rabbani Arian", style: TextStyle(color: Color(0xFFBFA181))),
                      Text("Nama Panggilan: Farell", style: TextStyle(color: Color(0xFFBFA181))),
                      Text("NPM: 4522210096", style: TextStyle(color: Color(0xFFBFA181))),
                      Text("Jenis Kelamin: Laki - laki", style: TextStyle(color: Color(0xFFBFA181))),
                      Text("Nomor Telepon: 08999223611", style: TextStyle(color: Color(0xFFBFA181))),
                    ],
                  ),
                ),
              ],
