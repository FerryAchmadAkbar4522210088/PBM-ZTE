...
class _ChrisPageState extends State<ChrisPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Profil Chris", style: TextStyle(color: Color(0xFFBFA181))),
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: ClipOval(
                    child: Image.asset("assets/chriss.jpeg", fit: BoxFit.cover),
                  ),
                ),
                SizedBox(height: 20),
                Container(
                  ...
                  child: Column(
                    ...
                    children: const [
                      Text("Nama Lengkap: Christian Jonathan Kolinug", style: TextStyle(color: Color(0xFFBFA181))),
                      Text("Nama Panggilan: Chris", style: TextStyle(color: Color(0xFFBFA181))),
                      Text("NPM: 4522210105", style: TextStyle(color: Color(0xFFBFA181))),
                      Text("Jenis Kelamin: Laki - laki", style: TextStyle(color: Color(0xFFBFA181))),
                      Text("Nomor Telepon: 082125062257", style: TextStyle(color: Color(0xFFBFA181))),
                    ],
                  ),
                ),
              ],
