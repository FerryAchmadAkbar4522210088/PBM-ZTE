...
class _BayuPageState extends State<BayuPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Profil Bayu", style: TextStyle(color: Color(0xFFBFA181))),
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: ClipOval(
                    child: Image.asset("assets/bayu.jpeg", fit: BoxFit.cover),
                  ),
                ),
                SizedBox(height: 20),
                Container(
                  ...
                  child: Column(
                    ...
                    children: const [
                      Text("Nama Lengkap: Bahrudin Yusuf", style: TextStyle(color: Color(0xFFBFA181))),
                      Text("Nama Panggilan: Bayu", style: TextStyle(color: Color(0xFFBFA181))),
                      Text("NPM: 4522210076", style: TextStyle(color: Color(0xFFBFA181))),
                      Text("Jenis Kelamin: Laki - laki", style: TextStyle(color: Color(0xFFBFA181))),
                      Text("Nomor Telepon: 085892720034", style: TextStyle(color: Color(0xFFBFA181))),
                    ],
                  ),
                ),
              ],
